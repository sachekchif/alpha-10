...
export default function InvestmentEducationDetailPage() {
  return (
    <RoleGuard allowedRoles={['SuperAdmin', 'Control']}>
      <InvestmentEducationDetailContent />
    </RoleGuard>
  );
}

function InvestmentEducationDetailContent() {
  ...
  function openEdit() {
    ...
    setSteps(rawSteps.length > 0 ? rawSteps : ['Choose a fund that matches your goals.']);
    setCoverImage(null);
    setFormErrors({});
    setIsEditing(true);
  }
  ...
  async function handleUpdate(e: React.FormEvent) {
    ...
    try {
      ...
      toast.success('Investment education content updated successfully.', 'Updated');
      setIsEditing(false);
    } catch (err: any) {
  ...
  async function handleDelete() {
    try {
      ...
      toast.success('Content deleted successfully.', 'Deleted');
  ...
  return (
    <div className="flex flex-col gap-6 pb-12 w-full animate-in fade-in duration-500">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 bg-transparent pb-3 border-b border-gray-200/60 dark:border-gray-800">
        <div>
          <button
            onClick={() => router.push('/dashboard/retail/education')}
          ...
          >
            <ArrowLeft size={14} /> Back to Investment Education
          </button>
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white tracking-tight">
            {item?.title || 'Loading Course Details...'}
          </h1>
          {item && (
      ...
      {isLoading ? (
        <div className="flex flex-col items-center justify-center py-20 gap-3 text-gray-400">
          ...
          <span className="text-sm font-medium">Loading course analysis...</span>
        </div>
      ) : isError || !item ? (
        <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 p-12 flex flex-col items-center gap-3 text-gray-400">
          ...
          <p className="text-sm font-medium">Failed to load content details.</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 w-full">
          ...
          <div className="lg:col-span-8 space-y-6">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700/80 p-6 shadow-xs">
              ...
              {parsedSteps.length > 0 ? (
                ...
                <p className="text-xs text-gray-400 italic">No step-by-step guide provided for this course yet.</p>
              )}
            </div>
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            {/* Course Engagement & Viewer Analytics */}
            <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700/80 p-5 space-y-4 shadow-xs">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div className="p-3 rounded-xl bg-gray-50 dark:bg-gray-900/40 border border-gray-100 dark:border-gray-800">
                  ...
                  <p className="text-[10px] text-emerald-600 font-medium">Learning live</p>
                </div>
              </div>
            </div>
      ...
      >
        <div className="py-2 text-center">
          ...
          <h3 className="text-base font-bold text-gray-900 dark:text-white mb-2">Delete Content</h3>
